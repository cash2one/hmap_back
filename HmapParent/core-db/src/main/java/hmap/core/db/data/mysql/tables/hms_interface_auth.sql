...
--
-- Table structure for table `hms_interface_auth`
--

DROP TABLE IF EXISTS `hms_interface_auth`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `hms_interface_auth` (
  `INTERFACE_AUTH_ID` varchar(255) NOT NULL,
  `AUTH_ID` varchar(255) NOT NULL,
  `INTERFACE_HEADER_ID` varchar(255) DEFAULT NULL,
  `INTERFACE_LINE_ID` varchar(255) DEFAULT NULL,
...
-- Dump completed on 2016-11-18  9:06:42
