CREATE TABLE `HMS_CONTACT_TAG` (
  `ID` VARCHAR(240) NOT NULL ,
  `TAG_NAME` VARCHAR(200) NOT NULL,
  `TAG_STATUS` VARCHAR(2000) DEFAULT NULL,
  `TAG_OWNER` VARCHAR(200) DEFAULT NULL,
  `TAG_PINYIN` VARCHAR(200) DEFAULT NULL,
  `TAG_PINYIN_CAPITAL` VARCHAR(200) DEFAULT NULL,
