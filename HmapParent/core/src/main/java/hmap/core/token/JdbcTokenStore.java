...
public class JdbcTokenStore implements TokenStore {
    ...
    private static final String DEFAULT_ACCESS_TOKEN_FROM_AUTHENTICATION_SELECT_STATEMENT = "select t1.token_id, t1.token from oauth_access_token t1 where t1.authentication_id = ? AND t1.token_id = (SELECT MAX(token_id) FROM oauth_access_token t2 WHERE t1.authentication_id=t2.authentication_id)";
