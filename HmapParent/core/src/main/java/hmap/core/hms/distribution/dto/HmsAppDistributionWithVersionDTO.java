 ...
 * Package Name:hmap.core.hms.distribution.dto Date:2017/1/24 0024 Create
...
public class HmsAppDistributionWithVersionDTO {
  ...
  private List<HmsAppVersion> allVersions;
  ...
  public List<HmsAppVersion> getAllVersions() {
    return allVersions;
  }

  public void setAllVersions(List<HmsAppVersion> allVersions) {
